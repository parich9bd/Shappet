  ...
  return (
    <section className={styles.hero}>
      ...
      <div className={styles.content}>
        ...
        <p>
          با شاپت ، دغدغه اورجینال بودن رو نداشته باش . جزو اولین ها در ایران با
          بیش از ۹ سال تخصص در حوزه حیوانات خانگی و مورد تایید دامپزشک های مطرح
          ایران ، خاص ترین غذا برای خاص ترین نژاد ها فقط در شاپت
        </p>
        {/* <span style={{ color: "#F7763D" }}>شاپت همراه پت</span> */}

        <Link href="/dogsProducts" className={styles.btn}>
          خرید کنید
          <ArrowLeft size={18} />
        </Link>
      </div>
