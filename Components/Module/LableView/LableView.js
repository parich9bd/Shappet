  ...
  return (
    <section className={styles.hero}>
      ...
      <div className={styles.content}>
        ...
        <p>
          با شاپت ، دغدغه اورجینال بودن رو نداشته باش . جزو اولین ها در ایران
          با بیش از ۹ سال تخصص در حوزه حیوانات خانگی و مورد تایید دامپزشک های مطرح ایران ، خاص ترین
